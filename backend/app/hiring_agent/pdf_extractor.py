...
def parse_resume_sections(text_content: str, llm_call_fn) -> ExtractedResume:
    ...
    with ThreadPoolExecutor(max_workers=6) as executor:
        future_map = {executor.submit(_call_llm_section, llm_call_fn, s, text_content): s for s in sections}
...
def convert_resume_to_evaluation_text(
    resume: ExtractedResume, github_text: str = "", portfolio_text: str = "", live_demo_text: str = ""
) -> str:
    parts = []
    if resume.raw_text:
