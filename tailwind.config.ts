  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Aceternity: Beam drift
        "beam-drift": {
          "0%, 100%": { transform: "translateY(0) rotate(0deg)", opacity: "0.6" },
          "25%": { transform: "translateY(-10%) rotate(1deg)", opacity: "0.8" },
          "50%": { transform: "translateY(0%) rotate(-0.5deg)", opacity: "0.5" },
          "75%": { transform: "translateY(10%) rotate(0.5deg)", opacity: "0.9" },
        },
        // Aceternity: Orbital rotation
        orbit: {
        ...
        "spotlight-sweep": {
          ...
          "100%": { opacity: "0", transform: "translate(30%, 30%) scale(0.8)" },
        },
        // Border glow pulse
        "border-glow": {
      ...
      animation: {
        ...
        "beam-drift": "beam-drift 20s ease-in-out infinite",
